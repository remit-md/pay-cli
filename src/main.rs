...
#[derive(Parser)]
#[command(name = "pay", version, about, after_help = "Output is JSON by default. Use --no-json for human-readable output.")]
struct Cli {
    /// Disable JSON output (JSON is the default)
